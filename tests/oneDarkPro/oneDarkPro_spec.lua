require("plenary.reload").reload_module("oneDarkPro", true)
local oneDarkPro = require("oneDarkPro")
local default = oneDarkPro.config

describe("setup", function()
  it("works with default values", function()
    oneDarkPro.setup()
    assert.are.same(oneDarkPro.config, default)
  end)
  ...
  it("works with old italic values", function()
    ...
    oneDarkPro.setup({ italic = true })
    assert.are.same(oneDarkPro.config, expected)
  end)
  ...
  it("works with config overrides", function()
    ...
    oneDarkPro.setup({ undercurl = false, underline = false })
    assert.are.same(oneDarkPro.config, expected)
  end)
end)
